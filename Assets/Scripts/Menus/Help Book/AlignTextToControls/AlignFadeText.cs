...
/// <summary>
/// Aligns move text to match controls on fade help book panel.
/// </summary>
public class AlignFadeText : MonoBehaviour
{
    ...
    {
        _text.text = "Hold '" + ReadAction() + "' to see objects beneath panels.";
    }
